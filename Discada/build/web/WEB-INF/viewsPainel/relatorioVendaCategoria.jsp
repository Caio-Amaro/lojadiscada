...
<!-- Page content-->
                <div class="container-fluid">
                    <h1 class="mt-4">Relatório de Vendas</h1>
                        ...
                        <form class="form-inline">
                            <div class="container-fluid">
                              <div class="col-6">
                                <input type="search" id="form1" class="form-control" placeholder="Nome da Categoria" />
                        ...
                        <h5 style="margin-top:2em;"> Saldo por Categoria: </h5> <p> R$ 2.100,00 </p>
                 <hr>
                ...
                <div class="">
                    <table class="table">
                        ...
                        <tbody>
                            <c:forEach var="obj" items="${ControlePedido.pedDao.listaPedido}">
                            <tr>
