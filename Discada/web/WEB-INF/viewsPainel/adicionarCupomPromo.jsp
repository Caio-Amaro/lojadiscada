...
<body>               
    ...
    <div class="container-fluid" >
        <h4 id="sloganUm" class="mt-4" style="margin-bottom: 1em;">ADICIONAR NOVO CUPOM DE DESCONTO</h4>
        <hr>
    </div>
            ...
            <div class="col-8">
               ...
               <form action="${pageContext.request.contextPath}/adicionarCupomTroca" method="POST" class="list-group-item">
                        ...
                        <input id="blockProductDois" class="form-control" type="text" name="idcliente">
                           ...
                           <h5 id="sloganUm" style="margin-top: 2em;" >Valor do Cupom de Desconto</h5>
                           <p> | IMPORTANTE! Adicione um valor em PERCENTUAL | </p>
                           
                        
                        <hr>
                           <input id="blockProductDois" style="margin-bottom: 1.5em;" type="text" name="valorcupom" class="form-control" placeholder="porcentagem %">
                           <input name="troca" type="hidden" value="2">
                        <div class="form-group">
                            <button type="submit" class="btn btn-outline-dark" style="margin-bottom: 5em;">
                                  <i class="bi bi-plus-circle-dotted"> CRIAR NOVO CUPOM DE DESCONTO</i>
                            </button>
                        </div>
                </form>
            </div>
